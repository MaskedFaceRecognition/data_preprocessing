...
# 마스크 타입 결정  2번 타입이 제일 적절하다고 생각한다.
...
for face in faces:
    ...
    mask_my= [((landmarks.part(2).x), (landmarks.part(2).y)),
    ...
    mask_type = {1: fmask_a, 2: fmask_c, 3: fmask_e, 4:fmask_my}
    mask_type[choice2]
